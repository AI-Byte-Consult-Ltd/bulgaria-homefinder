...
descriptionIt: 'Monolocale (45 m²) al 4° piano nella Magnolia Residence 7, Sunny Beach. Nuovo edificio con Act 16 (2025). Composto da ingresso, zona giorno luminosa con angolo cottura e spazio notte, bagno e balcone. Il complesso offre piscina, ascensore, sicurezza e parcheggio. A circa 700 m dal mare. Ideale per vivere o investimento. Pagamento rateale disponibile.',
  ...
  {
    id: 'sunny-beach-yasen-studio-4180',
    title: 'Studio in YASEN Complex | Central Sunny Beach',
    titleBg: 'Студио в комплекс „ЯСЕН" | Центъра на Слънчев бряг',
    titleRu: 'Студия в комплексе «ЯСЕН» | Центр Солнечного Берега',
    titleDe: 'Studio im Komplex „YASEN" | Zentrum Sonnenstrand',
    titleIt: 'Monolocale nel complesso "YASEN" | Centro di Sunny Beach',
    price: 49000,
    location: 'Sunny Beach, Burgas',
    locationBg: 'Слънчев бряг, Бургас',
    locationRu: 'Солнечный Берег, Бургас',
    ...
    locationIt: 'Sunny Beach, Burgas',
    images: [
      'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_36a0896bb7e3c0f73b996bebd882d735.jpg',
      'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_40e322642c5371bea5f82ff2695ea84a.jpg',
      'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_4d0073040759b33fb8e672b7842b2746.jpg',
      'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_8b335619fe38317ab64ed03e10571c0d.jpg',
      'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_da3e4611608da6bca9aa54e2d15a12cf.jpg',
    ],
    image: 'https://imperiumrealty.bg/realty/uploads/objects/4180/modified/full_36a0896bb7e3c0f73b996bebd882d735.jpg',
    type: 'studio',
    transactionType: 'sale' as const,
    status: 'for-sale',
    featured: false,
    ...
    parkingSpots: null,
    maintenanceFee: 330,
    description: 'Fully furnished studio (33 m²) on the ground floor of the YASEN residential complex in central Sunny Beach, just 200 m from the beach. Layout: entrance hall, living area with kitchenette, sleeping zone, bathroom with WC (no terrace). Building commissioned with Act 16. The complex features a large swimming pool, landscaped grounds and controlled access. Excellent central location near shops, restaurants, transport and entertainment. Move-in ready — ideal as a holiday home or rental investment. Annual maintenance fee: €330.',
    descriptionBg: 'Напълно обзаведено студио (33 м²) на партерен етаж в жилищен комплекс „ЯСЕН" в централната част на Слънчев бряг, на 200 м от плажа. Разпределение: входно антре, дневна с кухненска зона, зона за спане, баня с тоалетна (без тераса). Сградата е въведена в експлоатация с Акт 16. Комплексът предлага голям басейн, озеленени площи и контролиран достъп. Отлична локация в центъра на курорта, в близост до магазини, ресторанти, транспорт и развлечения. Готово за нанасяне — подходящо за ваканционен дом или инвестиция под наем. Годишна такса поддръжка: 330 €.',
    descriptionRu: 'Полностью меблированная студия (33 м²) на первом этаже жилого комплекса «ЯСЕН» в центре Солнечного Берега, в 200 м от пляжа. Планировка: прихожая, гостиная с кухонной зоной, спальная зона, ванная с туалетом (без террасы). Здание введено в эксплуатацию с Актом 16. В комплексе: большой бассейн, озеленённая территория, контролируемый доступ. Отличная локация в центре курорта — рядом магазины, рестораны, транспорт и развлечения. Готово к заселению — подходит как для отдыха, так и для сдачи в аренду. Ежегодная плата за обслуживание: 330 €.',
    descriptionDe: 'Voll möbliertes Studio (33 m²) im Erdgeschoss der Wohnanlage „YASEN" im Zentrum von Sonnenstrand, nur 200 m vom Strand. Aufteilung: Eingangsbereich, Wohnzimmer mit Küchenzeile, Schlafbereich, Bad mit WC (keine Terrasse). Gebäude mit Act 16 abgenommen. Die Anlage bietet einen großen Pool, gepflegte Grünflächen und kontrollierten Zugang. Hervorragende zentrale Lage in der Nähe von Geschäften, Restaurants, Verkehr und Unterhaltung. Bezugsfertig — ideal als Ferienwohnung oder Mietinvestition. Jährliche Wartungsgebühr: 330 €.',
    descriptionIt: 'Monolocale completamente arredato (33 m²) al piano terra del complesso residenziale "YASEN" nel centro di Sunny Beach, a soli 200 m dalla spiaggia. Disposizione: ingresso, zona giorno con angolo cottura, zona notte, bagno con WC (senza terrazza). Edificio con Atto 16. Il complesso dispone di una grande piscina, aree verdi curate e accesso controllato. Ottima posizione centrale, vicino a negozi, ristoranti, trasporti e intrattenimento. Pronto all\'uso — ideale come casa vacanze o investimento per affitti. Spese annuali: 330 €.',
  },
];

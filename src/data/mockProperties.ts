...
descriptionIt: 'Monolocale (45 m²) al 4° piano nella Magnolia Residence 7, Sunny Beach. Nuovo edificio con Act 16 (2025). Composto da ingresso, zona giorno luminosa con angolo cottura e spazio notte, bagno e balcone. Il complesso offre piscina, ascensore, sicurezza e parcheggio. A circa 700 m dal mare. Ideale per vivere o investimento. Pagamento rateale disponibile.',
  ...
  {
    id: 'ravda-bora-bora-3963',
    title: "Studio in Бора Бора | Ravda",
    titleBg: "Студио в Бора Бора | Равда",
    titleRu: "Студия в Бора Бора | Равда",
    titleDe: "Studio in Бора Бора | Rawda",
    titleIt: "Monolocale in Бора Бора | Ravda",
    price: 39900,
    location: 'Ravda, Burgas',
    locationBg: 'Равда, Бургас',
    locationRu: 'Равда, Бургас',
    locationDe: 'Rawda, Burgas',
    locationIt: 'Ravda, Burgas',
    image: '/placeholder.svg',
    ...
    parkingSpots: null,
    maintenanceFee: 210,
    description: "Studio (42 m²) in Ravda, Бора Бора complex. Floor: 5/5. Annual maintenance fee: €210. Excellent investment opportunity on the Bulgarian Black Sea coast.",
    descriptionBg: "Студио (42 м²) в Равда, комплекс Бора Бора. Етаж: 5/5. Годишна такса поддръжка: 210 €. Отлична инвестиционна възможност на Българското Черноморие.",
    descriptionRu: "Студия (42 м²) в Равда, комплекс Бора Бора. Этаж: 5/5. Ежегодная плата за обслуживание: 210 €. Отличная инвестиционная возможность на Болгарском побережье Чёрного моря.",
    descriptionDe: "Studio (42 m²) in Rawda, Anlage Бора Бора. Etage: 5/5. Jährliche Wartungsgebühr: 210 €. Hervorragende Investitionsmöglichkeit an der bulgarischen Schwarzmeerküste.",
    descriptionIt: "Monolocale (42 m²) a Ravda, complesso Бора Бора. Piano: 5/5. Spese annuali: 210 €. Ottima opportunità di investimento sulla costa bulgara del Mar Nero.",
  },
  {

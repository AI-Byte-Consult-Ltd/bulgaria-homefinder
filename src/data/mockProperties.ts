...
Nuova costruzione di qualità con ottime dotazioni. Più unità disponibili — contattateci per prezzi su acquisto multiplo. Ideale per investitori che costruiscono un portafoglio a Burgas.`,
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    parkingSpots: null,
    maintenanceFee: null,
    description: 'Traditional village house in Orlintsi, Bulgaria. An affordable rural property ideal for a countryside retreat or renovation project.',
    descriptionBg: 'Традиционна селска къща в Орлинци, България. Достъпен селски имот, идеален за ваканционна къща или проект за ремонт.',
    descriptionRu: 'Традиционный сельский дом в Орлинцах, Болгария. Доступная недвижимость, идеальная для загородного отдыха или реновации.',
    descriptionDe: 'Traditionelles Dorfhaus in Orlintsi, Bulgarien. Eine erschwingliche ländliche Immobilie, ideal als Ferienhaus oder Renovierungsprojekt.',
    descriptionIt: 'Casa di villaggio tradizionale a Orlintsi, Bulgaria. Una proprietà rurale accessibile, ideale come rifugio di campagna o progetto di ristrutturazione.',
  },
  {
    ...
    parkingSpots: null,
    maintenanceFee: 210,
    description: 'Compact studio apartment on the 5th floor of the Bora Bora complex in Ravda, close to the Black Sea coast. Maintenance fee: €210/year.',
    descriptionBg: 'Компактно студио на 5-ти етаж в комплекс Бора Бора в Равда, близо до Черноморското крайбрежие. Такса поддръжка: €210/год.',
    descriptionRu: 'Компактная студия на 5-м этаже комплекса Бора Бора в Равде, недалеко от Черноморского побережья. Такса обслуживания: €210/год.',
    descriptionDe: 'Kompaktes Studio im 5. Stock der Anlage Bora Bora in Ravda, nahe der Schwarzmeerküste. Wartungsgebühr: €210/Jahr.',
    descriptionIt: 'Monolocale compatto al 5° piano del complesso Bora Bora a Ravda, vicino alla costa del Mar Nero. Spese di manutenzione: €210/anno.',
  },
  {
    ...
    parkingSpots: null,
    maintenanceFee: 210,
    description: 'Studio apartment on the 5th floor of the Bora Bora complex in Ravda. Ideal seaside investment near the Black Sea. Maintenance fee: €210/year.',
    descriptionBg: 'Студио на 5-ти етаж в комплекс Бора Бора в Равда. Идеална инвестиция край морето. Такса поддръжка: €210/год.',
    descriptionRu: 'Студия на 5-м этаже комплекса Бора Бора в Равде. Идеальная приморская инвестиция. Такса обслуживания: €210/год.',
    descriptionDe: 'Studio im 5. Stock der Anlage Bora Bora in Ravda. Ideale Küsteninvestition. Wartungsgebühr: €210/Jahr.',
    descriptionIt: 'Monolocale al 5° piano del complesso Bora Bora a Ravda. Investimento ideale vicino al mare. Spese di manutenzione: €210/anno.',
  },
  {
    id: 'ravda-elitonia-gardens-2570',
    title: '1-Bedroom Apartment in Elitonia Gardens 3 | Ravda',
    titleBg: 'Едностаен апартамент в Elitonia Gardens 3 | Равда',
    titleRu: 'Однокомнатная квартира в Elitonia Gardens 3 | Равда',
    titleDe: '1-Zimmer-Wohnung in Elitonia Gardens 3 | Ravda',
    titleIt: 'Appartamento con 1 camera in Elitonia Gardens 3 | Ravda',
    price: 86000,
    location: 'Ravda, Burgas',
    locationBg: 'Равда, Бургас',
    locationRu: 'Равда, Бургас',
    ...
    parkingSpots: null,
    maintenanceFee: 438,
    description: '1-bedroom apartment on the 4th floor of Elitonia Gardens 3 complex in Ravda. 55 m², well-maintained resort complex near the sea. Maintenance fee: €438/year.',
    descriptionBg: 'Едностаен апартамент на 4-ти етаж в комплекс Elitonia Gardens 3 в Равда. 55 м², поддържан курортен комплекс до морето. Такса: €438/год.',
    descriptionRu: 'Однокомнатная квартира на 4-м этаже комплекса Elitonia Gardens 3 в Равде. 55 м², ухоженный курортный комплекс у моря. Такса обслуживания: €438/год.',
    descriptionDe: '1-Zimmer-Wohnung im 4. Stock der Anlage Elitonia Gardens 3 in Ravda. 55 m², gepflegte Ferienanlage am Meer. Wartungsgebühr: €438/Jahr.',
    descriptionIt: 'Appartamento con 1 camera al 4° piano del complesso Elitonia Gardens 3 a Ravda. 55 m², complesso turistico ben curato vicino al mare. Spese: €438/anno.',
  },
  {
  ...
  },
  {
    ...
    parkingSpots: null,
    maintenanceFee: 540,
    description: 'Studio apartment (45 m²) on the 4th floor of Magnolia Residence 7 in Sunny Beach. Installment payment available. Maintenance fee: €540/year.',
    descriptionBg: 'Студио (45 м²) на 4-ти етаж в Magnolia Residence 7 в Слънчев бряг. Възможност за разсрочено плащане. Такса: €540/год.',
    descriptionRu: 'Студия (45 м²) на 4-м этаже в Magnolia Residence 7 в Солнечном Берегу. Возможна рассрочка. Такса обслуживания: €540/год.',
    descriptionDe: 'Studio (45 m²) im 4. Stock der Magnolia Residence 7 in Sonnenstrand. Ratenzahlung möglich. Wartungsgebühr: €540/Jahr.',
    descriptionIt: 'Monolocale (45 m²) al 4° piano nella Magnolia Residence 7 a Sunny Beach. Pagamento rateale disponibile. Spese: €540/anno.',
  },
];
